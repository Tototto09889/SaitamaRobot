...
def site_search(update: Update, context: CallbackContext, site: str):
    ...
    if site == "nekopoi":
        search_url = fhttps://nekopoi.xgorntv.workers.dev/?s={search_query}"
...
@run_async
def nekopoi(update: Update, context: CallbackContext):
    site_search(update, context, "nekopoi")
...
*Available commands:*
 ...
 • `/nekopoi <anime>`*:* search an anime on https://nekopoi.xgorntv.workers.dev
...
NEKOPOI_SEARCH_HANDLER = DisableAbleCommandHandler("nekopoi", nekopoi)
...
dispatcher.add_handler(NEKOPOI_SEARCH_HANDLER)
dispatcher.add_handler(KUSO_SEARCH_HANDLER)
dispatcher.add_handler(UPCOMING_HANDLER)

__mod_name__ = "Anime"
__command_list__ = [
    "anime", "manga", "character", "user", "upcoming", "nekopoi", "airing",
    "kuso"
]
__handlers__ = [
    ANIME_HANDLER, CHARACTER_HANDLER, MANGA_HANDLER, USER_HANDLER,
    UPCOMING_HANDLER, NEKOPOI_SEARCH_HANDLER, KUSO_SEARCH_HANDLER,

...
HELP_STRINGS = """
Hey Kawan! Namaku adalah *{}*.
Aku akan sekuat tenaga membantumu.
...
Hana Uzaki is hosted on one of Kaizoku's Servers and doesn't require any donations as of now but \
